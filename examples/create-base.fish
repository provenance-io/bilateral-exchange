...
build/provenanced -t --home build/run/provenanced add-genesis-account buyer 100usd,100000000nhash --keyring-backend test ;
build/provenanced -t --home build/run/provenanced add-genesis-account seller 100gme,100000000nhash --keyring-backend test ;
